<?php
    ...
    $sql = "SELECT register_activity.*, member.mb_name, branch.branch_name, faculty.faculty_name FROM register_activity 
            ...
            WHERE act_id = :act_id AND register_status = 'ยังไม่เช็คชื่อ' ";
