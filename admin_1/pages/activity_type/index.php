...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        ...
        $(function() {
            $.ajax({
                type: "GET",
                url: "../../service/activity_type/index.php"
            }).done(function(data) {
                let tableData = []
                data.response.forEach(function(item, index) {
                    tableData.push([
                        ...
                        <a href="form-edit.php?at_id=${item.at_id}" type="button" class="btn btn-warning text-white">
                            <i class="far fa-edit"></i> แก้ไข
                        </a>
                        <button type="button" class="btn btn-danger" id="delete" data-id="${item.at_id}" data-index="${index}">
                        ...
                        $(document).on('click', '#delete', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        type: "DELETE",
                                        url: "../../service/activity_type/delete.php",
                                        data: JSON.stringify({
                                            at_id: at_id
                                        }),
