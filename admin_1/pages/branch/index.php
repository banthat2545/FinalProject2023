            ...
            $.ajax({
                ...
                data.response.forEach(function(item, index) {
                    tableData.push([
                        ...
                        <a href="form-edit.php?branch_id=${item.branch_id}" type="button" class="btn btn-warning text-white">
                            <i class="far fa-edit"></i> แก้ไข
                        </a>
                        <button type="button" class="btn btn-danger" id="delete" data-id="${item.branch_id}" data-index="${index}">
