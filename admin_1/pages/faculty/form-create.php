                                        ...
                                        <div class="row">
                                            <div class="col-md-12 px-1 px-md-5">
                                                <!-- <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="faculty_id" id="faculty_id" placeholder="รหัสคณะ" required>
                                                </div> -->
                                                <div class="form-group">
                                                    <label for="faculty_name">ชื่อคณะ</label>
                                                    <input type="text" class="form-control" name="faculty_name" id="faculty_name" placeholder="ชื่อคณะ" required>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(function() {
            $('#formData').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../service/faculty/create.php',
