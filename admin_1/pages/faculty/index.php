            ...
            $.ajax({
                ...
                data.response.forEach(function(item, index) {
                    tableData.push([
                        ...
                        <a href="form-edit.php?faculty_id=${item.faculty_id}" type="button" class="btn btn-warning text-white">
                            <i class="far fa-edit"></i> แก้ไข
                        </a>
                        <button type="button" class="btn btn-danger" id="delete" data-id="${item.faculty_id}" data-index="${index}">
            ...
            function initDataTables(tableData) {
                $('#logs').DataTable({
                    ...
                    columns: [{title: "ลำดับ", className: "align-middle"},
                        {title: "รหัสคณะ", className: "align-middle"},
                        {title: "ชื่อคณะ", className: "align-middle"},
                        ...
                        $(document).on('click', '#delete', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        type: "DELETE",
                                        url: "../../service/faculty/delete.php",
                                        data: JSON.stringify({
