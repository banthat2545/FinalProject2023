...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="../member_one/index-super.php?id=<?php echo $_SESSION['MB_ID']; ?>" class="d-block"> <?php echo $_SESSION['MB_NAME']; ?> </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="../dashboard_1/" class="nav-link <?php echo isActive('dashboard_1') ?>">
                ...
                <li class="nav-item">
                    <a href="../member/" class="nav-link <?php echo isActive('member') ?>">
                        <i class="nav-icon fas fa-users"></i>
                        <p>สมาชิกชมรม</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../club/" class="nav-link <?php echo isActive('club') ?>">
                        <i class="nav-icon fas fa-cube"></i>
                        <p>ชมรม</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../faculty/" class="nav-link <?php echo isActive('faculty') ?>">
