                ...
                <div class="row">
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-success shadow">
                            ...
                            <a href="../activity/" class="small-box-footer py-3"> คลิกดูกิจกรรม <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-primary shadow">
                            <div class="inner text-center">
                                <h1 class="py-3">ผลกิจกรรม</h1>
                            </div>
                            <a href="#" class="small-box-footer py-3"> ตรวจสอบผลกิจกรรม <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- <div class="row">
